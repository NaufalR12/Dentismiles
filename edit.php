...
<body>
    ...
    <!-- Edit start -->
    <div class="container text-center mb-5 ml-5 mt-5 mr-5 p-5">
        <div class="row">
            <div class="col">
    ...
    $query = "SELECT id_dokter, nama_dokter, spesialisasi, jam_mulai, jam_berakhir FROM dokter WHERE id_dokter = $id_dokter";
    ...
    ?>
                                <form action="proses_edit_dokter.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group mt-3">
                                        <div class="row align-items-center ">
                                            <div class="col-3 text-start">
                                                <label for="jam_mulai">Mulai praktik:</label>
                                            </div>
                                            <div class="col-8">
                                                <input type="time" class="form-control" name="jam_mulai"
                                                    value="<?php echo $data_dokter['jam_mulai']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group mt-3">
                                        <div class="row align-items-center ">
                                            <div class="col-3 text-start">
                                                <label for="jam_berakhir">Berakhir praktik:</label>
                                            </div>
                                            <div class="col-8">
                                                <input type="time" class="form-control" name="jam_berakhir"
                                                    value="<?php echo $data_dokter['jam_berakhir']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
